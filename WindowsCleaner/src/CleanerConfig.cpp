...
std::wstring CleanerConfig::ExpandPath(const std::wstring& path) {
    ...
    while ((pos = expanded.find(L'%', pos)) != std::wstring::npos) {
        ...
        std::wstring varValue = FileUtils::GetEnvVar(varName);
...
std::vector<CleanTarget> CleanerConfig::GetSystemTargets() {
    return {
        // Temporary Files
...
std::vector<CleanTarget> CleanerConfig::GetBrowserTargets() {
    return {
...
std::vector<CleanTarget> CleanerConfig::GetDevToolTargets() {
    return {
        // VS Code
...
std::vector<CleanTarget> CleanerConfig::GetGamingTargets() {
    return {
        // Discord
...
std::vector<CleanTarget> CleanerConfig::GetMediaTargets() {
    return {
        // Media Players
...
std::vector<CleanTarget> CleanerConfig::GetAllTargets() {
